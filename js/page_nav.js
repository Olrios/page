(function($) {
    ...
    $.ias.defaults = {
        ...
        loader: '<img src="https://2.bp.blogspot.com/-OppefDeiUDA/UVwLAL_B_mI/AAAAAAAAPO4/y8T9CPORHq4/s1600/loadersz.gif" class="loader-page"/>',
        loaderDelay: 600,
    ...
    $.ias.util = function() {
        ...
        function init() {
/** fix by andu, changed this $(window).load(function() { to whats lower line now**/
            $(function() {
                c = true
            })
        }
